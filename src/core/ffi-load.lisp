...
(progn
  ...
  (load-shared-object "lib/libma_shim.so"   :dont-save t))
...
(progn
  ...
  (load-shared-object "lib/libma_shim.dylib" :dont-save t))
...
(progn
  ...
  (load-shared-object "lib/ma_shim.dll"     :dont-save t))
